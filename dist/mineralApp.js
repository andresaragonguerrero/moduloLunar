...
import { SmallScreenView } from "./smallScreenView.js";
const form = document.getElementById('form-mineral');
const labelController = new SmallScreenView(".form .label");
const mediaquery = globalThis.matchMedia("(max-width: 768px)");
// Realmente oculta los labels
function applySmallScreen(e) {
    if (e.matches)
        labelController.hide();
    else
        labelController.show();
}
applySmallScreen(mediaquery);
mediaquery.addEventListener("change", applySmallScreen);
